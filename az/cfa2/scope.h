// calculate variable stack / heap / global type
// original code is derived from iv/lv5, railgun/scope.h
#ifndef _AZ_CFA2_SCOPE_H_
#define _AZ_CFA2_SCOPE_H_
#include <iv/noncopyable.h>
namespace az {
namespace cfa2 {

class VariableScope : private iv::core::Noncopyable<VariableScope> {
 public:
  enum Type {
    STACK = 0,
    HEAP
